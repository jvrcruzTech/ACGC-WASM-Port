...
static void aTBG1_setupAction(ACTOR*actor, int action){
    ...
    static BAG1_PROC process[] = {
        PC_WASM_NOOP_PROC(BAG1_PROC),PC_WASM_NOOP_PROC(BAG1_PROC),PC_WASM_NOOP_PROC(BAG1_PROC),aTBG1_destruct,PC_WASM_NOOP_PROC(BAG1_PROC),PC_WASM_NULL_NOOP_PROC(BAG1_PROC)
    };
