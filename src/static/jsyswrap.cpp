...
extern void JW_Init() {
    ...
    OSReport("[WEB/BOOT] before JFWSystem_init\n");
    JC_JFWSystem_init();
    OSReport("[WEB/BOOT] after JFWSystem_init\n");
    OSReport("[WEB/BOOT] before system heap group\n");
    JC_JKRExpHeap_changeGroupID(JC_JFWSystem_getSystemHeap(), 1);
    OSReport("[WEB/BOOT] before console setup\n");
    ...
    OSReport("[WEB/BOOT] before display settings\n");
    ...
    OSReport("[WEB/BOOT] before logo setup\n");
